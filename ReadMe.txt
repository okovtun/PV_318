...
2. Удалить значение из вектора по указанному индексу, индекс вводит пользователь;
3. Выполнить те же действия с контейнером 'std::list';
4. Реализовать Stack на базе односвязного списка;
5. Реализовать Queue на базе двусвязного списка;
